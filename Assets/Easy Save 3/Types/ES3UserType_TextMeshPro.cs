...
namespace ES3Types
{
	...
	public class ES3UserType_TextMeshPro : ES3ComponentType
	{
		...
		protected override void WriteComponent(object obj, ES3Writer writer)
		{
			...
			writer.WriteProperty("richText", instance.richText, ES3Type_bool.Instance);
		...
		protected override void ReadComponent<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					break;
					case "m_renderer":
					reader.SetPrivateField("m_renderer", reader.Read<UnityEngine.Renderer>(), instance);
					break;
					case "m_maskType":
					reader.SetPrivateField("m_maskType", reader.Read<TMPro.MaskingTypes>(), instance);
					break;
					case "_SortingLayer":
					reader.SetPrivateField("_SortingLayer", reader.Read<System.Int32>(), instance);
					break;
					case "_SortingLayerID":
					reader.SetPrivateField("_SortingLayerID", reader.Read<System.Int32>(), instance);
					break;
					case "_SortingOrder":
					reader.SetPrivateField("_SortingOrder", reader.Read<System.Int32>(), instance);
					break;
					case "m_text":
					...
					case "font":
						...
						break;
					case "richText":
						instance.richText = reader.Read<System.Boolean>(ES3Type_bool.Instance);
						break;
					case "color":
