...
namespace ES3Types
{
	...
	public class ES3UserType_ES3UserType_ES3Type_GameObject : ES3ObjectType
	{
		public static ES3Type Instance = null;

		public ES3UserType_ES3UserType_ES3Type_GameObject() : base(typeof(ES3Types.ES3UserType_ES3Type_GameObject)){ Instance = this; priority = 1; }


		protected override void WriteObject(object obj, ES3Writer writer)
		{
			var instance = (ES3Types.ES3UserType_ES3Type_GameObject)obj;
			
			writer.WriteProperty("Instance", ES3Types.ES3UserType_ES3Type_GameObject.Instance);
		...
		protected override void ReadObject<T>(ES3Reader reader, object obj)
		{
			...
			foreach(string propertyName in reader.Properties)
			{
				switch(propertyName)
				{
					...
					case "Instance":
						ES3Types.ES3UserType_ES3Type_GameObject.Instance = reader.Read<ES3Types.ES3Type>();
						break;
					case "type":
		...
		{
			var instance = new ES3Types.ES3UserType_ES3Type_GameObject();
	...
	public class ES3UserType_ES3UserType_ES3Type_GameObjectArray : ES3ArrayType
	{
		public static ES3Type Instance;

		public ES3UserType_ES3UserType_ES3Type_GameObjectArray() : base(typeof(ES3Types.ES3UserType_ES3Type_GameObject[]), ES3UserType_ES3UserType_ES3Type_GameObject.Instance)
		{
			Instance = this;
		}
	}
