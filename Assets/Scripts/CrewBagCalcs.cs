...
public class CrewBagCalcs : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        GameObject obj = MainCanvas.transform.GetChild(23).transform.GetChild(0).gameObject;  // this is the weight input field on maincanvas, Crew Bags Panel
