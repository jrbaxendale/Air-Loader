...
public class DeleteLogsQd : MonoBehaviour
{
    ...
    public void DeleteThis()
    {
        ...
        Transform DeleteObject3 = DeleteObject2.transform.parent.GetChild(index + 2);
        ...
        Transform DeleteObject4 = DeleteObject2.transform.parent.GetChild(index + 4);
        ...
        Transform DeleteObject5 = DeleteObject2.transform.parent.GetChild(index + 6);
