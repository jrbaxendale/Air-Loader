...
public class ContactMoveLogsTpl : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        Destroy(gameObject.GetComponent<ContactTplLOGS>());
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonUp(0) && (col == true) && (placed == false) && (othertransform.gameObject.name == "collider"))
        {
            ...
            gameObject.transform.localPosition = new Vector3(0, -8.7f, 0);
            ...
            GameObject oldCollider = MoveACPlogsTpl.Old1Collider;
           ...
           Raycast.pause = false;
            oldCollider = MoveACPlogsTpl.Old1Collider.gameObject;
            Debug.Log("Move Complete");
            Destroy(MoveACPlogsTpl.movebtn);
            Destroy(this);
