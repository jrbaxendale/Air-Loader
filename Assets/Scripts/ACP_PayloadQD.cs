...
public class ACP_PayloadQD : MonoBehaviour
{
    ...
    public float midfwdWeight;
    public float midaftWeight;
    ...
    public GameObject MIDFWDweight;
    public GameObject MIDAFTweight;
    ...
    private void Awake()
    {
        ...
        midaftWeight = Int32.Parse(MIDAFTweight.GetComponent<TMP_InputField>().text);
...

        {
            ...
            PalletWeight = fwdWeight + midfwdWeight + midaftWeight + aftWeight;
