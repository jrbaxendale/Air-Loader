...
public class MoveTPL : MonoBehaviour
{
    ...
    private void Start()
    {
        MoveObject = gameObject.transform.GetChild(3).gameObject.GetComponent<TPLcheckButtons>().SelectedACP.gameObject;
    ...
    public void MoveThis()
    {
        ...
        MoveObject.gameObject.GetComponent<ACP_PayloadTPL>().location = false;
        ...
        MoveObject.gameObject.GetComponent<ACP_PayloadTPL>().Locks = false;
        ...
        OriginalPosition = MoveObject.gameObject.GetComponent<ACP_PayloadTPL>().OriginalPosition;
        ...
        Debug.Log("SelectedACP is..." + gameObject.transform.GetChild(3).gameObject.GetComponent<TPLcheckButtons>().SelectedACP.transform.gameObject.name); //This is the position of the pallet prior to it being moved.
        ...
        MoveObject.AddComponent<ContactMoveTpl>(); // adds contactmove script to the pallet;
    ...
    public void CxMoveThis()
    {
        ...
        Destroy(MoveObject.gameObject.GetComponent<ContactMoveTpl>());
