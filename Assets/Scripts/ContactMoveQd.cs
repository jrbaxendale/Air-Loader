...
public class ContactMoveQd : MonoBehaviour
{
    ...
    private void Start()
    {
        Destroy(gameObject.GetComponent<ContactQd>());
    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonUp(0) && (col == true) && (placed == false) && (othertransform.gameObject.name == "collider"))
        {
            ...
            GameObject oldCollider = MoveACPlogsQd.Old1Collider;
            ...
            Raycast.pause = false;
            oldCollider = MoveACPlogsQd.Old1Collider.gameObject;
            Debug.Log("Move Complete");
            Destroy(MoveACPlogsQd.movebtn);
            Destroy(this);
