...
public class MoveDblADS : MonoBehaviour

{
    public bool placed = false;
    public bool col;
    public Collision othertransform;
#pragma warning disable CS0414 // The field 'MoveDblADS.dragging' is assigned but its value is never used
    private bool dragging = false;
#pragma warning restore CS0414 // The field 'MoveDblADS.dragging' is assigned but its value is never used
