...
public class PaxBagsFScalc : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        GameObject obj = MainCanvas.transform.GetChild(22).transform.GetChild(0).gameObject;  // this is the weight input field on maincanvas, Pax Panel
    ...
    public void Update() // this continously recalculates the moment. The MakePaxBags script adds the weight to the payload panel.
    {
        if (Added == false)
        {
