...
public class ContactQd : MonoBehaviour
{
...

    {
        ...
        if (collision.transform != null && collision.transform.parent.transform.GetComponent<Renderer>() != null)
        {
            ...
            collision.transform.parent.parent.transform.GetChild(collision.transform.parent.GetSiblingIndex() + 6).gameObject.GetComponent<Renderer>().material = HighlightedACP;
    ...
    public void OnCollisionExit(Collision collision)
    {
        if (collision.transform.parent.name.Contains("logs"))
        {
            ...
            collision.transform.parent.parent.transform.GetChild(collision.transform.parent.GetSiblingIndex() + 6).gameObject.GetComponent<Renderer>().material = LogsMat;
            ...
            if (othertransform != null)
            {
                ...
                if ((othertransform.transform.name.Contains("col")) && (col == true) && (placed == false))
                {
...

                    {
                        ...
                        gameObject.transform.localPosition = new Vector3(0, -11.9f, 0);
                        ...
                        Debug.Log("sibling index =" + gameObject.transform.parent.parent.transform.GetSiblingIndex());
                        Transform sibling3 = gameObject.transform.parent.parent.parent.transform.GetChild(gameObject.transform.parent.parent.transform.GetSiblingIndex() + 6);
                        GameObject sib3 = sibling3.gameObject;
                        sib3.gameObject.transform.GetChild(0).GetComponent<BoxCollider>().enabled = !enabled;
                        GameObject Make = GameObject.FindGameObjectWithTag("AddQuadACP");
