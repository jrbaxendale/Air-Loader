...
public class MoveTplADS : MonoBehaviour

{
    public bool placed = false;
    public bool col;
    public Collision othertransform;
#pragma warning disable CS0414 // The field 'MoveTplADS.dragging' is assigned but its value is never used
    private bool dragging = false;
#pragma warning restore CS0414 // The field 'MoveTplADS.dragging' is assigned but its value is never used
    ...
    public void MoveThis()
    {
        ...
        MoveObject.AddComponent<ContactMoveTpl>();
