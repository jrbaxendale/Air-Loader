...
public class DeleteQD : MonoBehaviour
{
    ...
    public void DeleteThis() // this deletes the selected pallet
    {
        ...
        decimal weightint = gameObject.transform.parent.transform.GetChild(3).gameObject.GetComponent<QDcheckButtons>().SelectedACP.gameObject.GetComponent<ACP_PayloadQD>().palletint;
        decimal palint = gameObject.transform.parent.transform.GetChild(3).gameObject.GetComponent<QDcheckButtons>().SelectedACP.gameObject.GetComponent<ACP_PayloadQD>().OldMoment;
